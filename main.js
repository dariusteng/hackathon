function sendTranslation(from_language, to_language, user_text) {
  const apiKey =
    'sk-proj-LCqDnyCknSBC9BrOKqcs remove me to use T3BlbkFJ4lS9S53ra3Derc2N9njJ';
  //REMOVE THE ' REMOVE ME TO USE ' SECTION OF THE ABOVE STRING TO COMPLETE THE STRING AND TO ALLOW THIS EXTENSION TO WORK.
  //DON'T COMMIT WITHOUT BREAKING UP THE KEY, OR ELSE GITHUB WON'T ALLOW PUSHING TO ITS SITE.
  //SIMPLY COMMENTING OUT THE STRING WON'T WORK, IT WILL BE DETECTED.
  ...
  const data = {
    ...
    messages: [
      {
        role: 'system',
        content: `Please help me translate ${from_language} to ${to_language}`,
      },
